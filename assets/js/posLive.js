var products = {
  // (A) PRODUCTS LIST
  list : {
    1 : { name:"Beer", description: "Local Draft", img:"beerHH.jpg", price: 5 },
    2 : { name:"Champagne", description: "House Bottle", img:"champagneHH.png", price: 7 },
    3 : { name:"Mixed Drinks", description: "Call Liqour", img:"mixDrinkHH.jpg", price: 5 },
    4 : { name:"Margarita", description: "Call Tequila", img:"rocksMargHH.jpg", price: 6 },
    5 : { name:"Chardonnay", description: "House White", img:"chardonnayHH.jpg", price: 5 },
    6 : { name:"Tapas", description: "Chef Selection", img:"tapasHH.jpg", price: 5 }
  },
  ...
  draw : () => {
    ...
    for (let pid in products.list) {
      ...
      // DESCRIPTION
      segment = document.createElement("div");
      segment.className = "pdescription";
      segment.innerHTML = p.description;
      pdt.appendChild(segment);
